        ...
        <div className='fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center'>
            ...
            '>
                ...
                <div className="flex item-center justify-center space-x-4">
                    ...
                    mr-2">yes</button>
                    <button onClick={onclose} className="px-4 py-2 border border-accent/30 border-solid hover:shadow-glass-sm 
                    rounded">No</button>
                </div>
    ...
    return (
        <div className='fixed top-4 right-2.5 xs:right-4 z-50 group '>
            ...
            <audio ref={audioRef} loop>
                <source src={"/audio/Evening Improvisation.mp3"} type="audio/mpeg" />
            ...
            <motion.button
                ...
                className="w-10 h-10 xs:w-14 xs:h-14 text-foreground rounded-full flex items-center justify-center 
                cursor-pointer z-50 p-2.5 xs:p-4 custom-bg
